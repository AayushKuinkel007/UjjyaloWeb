    ...
    <>
      <section id="home" className="mt-7 overflow-hidden">
        ...
        <div className="flex justify-center gap-5 mb-10">
          <button
            className="relative flex items-center gap-2 p-3 rounded-xl text-black bg-[#f48c25] shadow-[0_0_20px_#f48c25] hover:shadow-[0_0_0px_#f48c25] hover:scale-105 duration-500"
          >
